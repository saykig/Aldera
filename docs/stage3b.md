...
pnpm aldera inspect relationship:icbe-ucdp:0011 --json
...
Validation checks schema enums, stable ref namespaces, stable assertion IDs, duplicate IDs, duplicate endpoint pairs, benchmark path/hash/date provenance, exact transcription, bundle hash, assertion order, and—when supplied—native bundle hashes and endpoint resolution.
